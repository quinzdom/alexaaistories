...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Test. Welcome. Please choose a character and tell me its name.';
...
const ChatGPTIntentHandler = {
    ...
    async handle(handlerInput) {
        ...
        attr.conversation.push({ role : 'user', content : "Tell a funny story about " + question + " in about 100 words."});
...
const HelpIntentHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Welcome. Please choose a character and tell me its name.';
